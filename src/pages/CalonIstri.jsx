    ...
    const handleButtonClick = async () => {
        if (isExisting) {
            ...
            try {
                ...
                localStorage.setItem('calonIstri', JSON.stringify(pendudukNew));

                navigate('/datawali'); // Pindah ke halaman lain setelah menyimpan
            } catch (error) {
    ...
    return (
        <>
            ...
            <main className="flex-1 p-6 bg-gray-200 rounded-xl ml-80 mt-10 mr-14">
                <h1 className="text-2xl font-semibold mb-6">Data Calon Istri</h1>
                <form>
